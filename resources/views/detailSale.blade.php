    ...
    <header class="page-header" data-background="images/slide01.jpg" data-stellar-background-ratio="1.15">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{$sale->baslik}}</li>
            </ol>
        </div>
        <!-- end container -->
    </header>
            ...
            <div class="row">
                                ...
                                <div style="margin-left:auto; margin-right:auto;" class="gallery-slider">
                                    <div class="swiper gallery-container">
                                        <div class="swiper-wrapper">
                                            @foreach(json_decode($sale->image, true) as $image)
                ...
                <div class="col-lg-6">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <p style="font-size: 25px; color: #000000; font-weight: bold">{{$sale->baslik}} </p>
                            </div>
                            <div class="col-lg-12">
                ...
                <section style="padding: 0; border:none" class="sales-team">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <figure style="margin: 0;"><img style="margin-top:-168px" src="{{asset('storage/'.$sale->author->avatar)}}" alt="Image">
                                    <figcaption style="padding-left: 10px;">
                                        <h4>{{$sale->author->name}}</h4>
                                        <small>{{\Illuminate\Support\Facades\App::getLocale() == 'tr' ? 'Portföy Yöneticisi' : 'Property Manager'}}</small>
                                        <ul>
                                            <li><a href="#"><span>mobil:</span> +90 {{$sale->author->phone}}</a></li><br>
                                            <li><a href="#"><span>office:</span> +90 212 323 39 39</a></li>
                                            <li><a href="#"><span>e-mail:</span> {{$sale->author->email}}</a></li>
                                            <li><a href="mailto:{{$sale->author->email}}"
                            ...
                            <div class="col-md-6">
                              <div class="container">
                                  <div class="row">
                                      <div class="col-md-6"><a class="randevu-button" href="mailto:{{$sale->author->email}}">{{\Illuminate\Support\Facades\App::getLocale() == 'tr' ? 'Randevu Al' : 'Make an Appointment: '}}</a></div>
                                      <div class="col-md-6"><a class="randevu-button" href="tel:{{$sale->author->phone}}">{{\Illuminate\Support\Facades\App::getLocale() == 'tr' ? 'Bize Ulaşın' : 'Contact Us: '}}</a></div>
                                  </div>
                              </div>
