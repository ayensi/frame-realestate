...
@section('content')
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2><b>Gayrimenkul Tipleri</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#yeniEkle" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Yeni Tip</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                @if(count($estate_types)>0)
                    @foreach($estate_types as $c)
                        <tr>
                            <td>
							<span class="custom-checkbox">
    ...
    <div id="yeniEkle" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{route('estate_types.store')}}">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>İsim</label>
                            <input name="estate_type" type="text" class="form-control" required>
                        </div>
                    </div>
    ...
    <div id="DuzenleModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{route('estate_types.update')}}">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>İsim</label>
                            <input name="estate_type" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div id="SilModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{route('estate_types.destroy')}}" method="post">
                    @csrf
                    <div class="modal-header">
    ...
    <div id="CokluSilModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{route('estate_types.destroyMany')}}" method="post">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title">Kayıt Sil</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
@section('js')
    <script>
        ...
        $('#CokluSilModal').on('click',function (evt){
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('estate_types.destroyMany') }}",
                data:{ids:ids},
            });
        });
